...
def getWordScore(word, n):
    ...
    # Calculate the score by mapping all of letters and multiplying by len of word
    score = sum(map(lambda letter: SCRABBLE_LETTER_VALUES[letter], word)) * len(word)
    ...
    while (calculateHandlen(hand) > 0):
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                word_input_score = getWordScore(word_input, n)
                total_score += word_input_score

                print("\"{}\" earned {} points. Total: {} points\n".format(\
                        word_input, word_input_score, total_score))
